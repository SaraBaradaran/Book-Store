...
LibrarySystem::LibrarySystem()
{
    ...
    AddBook_btn->setGeometry(670,75,100,50);
    ShowBookList_btn = new QPushButton("Show Books");
    ShowBookList_btn->setGeometry(670,175,100,50);
    AddCustomer_btn = new QPushButton("Add Customer");
    AddCustomer_btn->setGeometry(670,275,100,50);
    GetFactor_btn = new QPushButton("Get Factor");
    GetFactor_btn->setGeometry(670,375,100,50);
    show_time = new QLabel("00:00:00");
    show_time->setGeometry(0,0,100,50);

    title_lbl = new QLabel;
    title_lbl->setText("<b>Book Store</b>");
    title_lbl->setGeometry(0,250,250,200);

    show_time->setAlignment(Qt::AlignCenter);

    QPixmap pix(":/background/bg3.jpg");
    scene->addPixmap(pix.scaled (800,500,Qt::KeepAspectRatio));
    ...
    scene->addWidget(show_time);
    scene->addWidget(title_lbl);

    AddBook_btn->setStyleSheet("background-color: rgb(119, 0, 255);color: white;font: 10pt Gorgia");
    ShowBookList_btn->setStyleSheet("background-color: rgb(119, 0, 255);color: white;font: 10pt Gorgia");
    AddCustomer_btn->setStyleSheet("background-color: rgb(119, 0, 255);color: white;font: 10pt Gorgia");
    GetFactor_btn->setStyleSheet("background-color: rgb(119, 0, 255);color: white;font: 10pt Gorgia");
    title_lbl->setStyleSheet("background-color: white;color: blue;font: 44pt Gorgia");
    show_time->setStyleSheet("background-color: white;color: blue;font: 10pt Gorgia");
...
void LibrarySystem::DeleteBookFromLibrary(QString name,QString year)
{
    ...
    Library->Print(ShowBook_obj->BookList);//refresh booklist
