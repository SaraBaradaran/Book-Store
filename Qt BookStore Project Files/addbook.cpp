...
AddBook::AddBook(LibrarySystem *libsystem):libsystem(libsystem)
{
    ...
    add_btn = new QPushButton("Add Book");
    ...
    QPixmap pix1(":/background/bg4.jpg");
    addbook_scene->addPixmap(pix1.scaled (800,500,Qt::KeepAspectRatio));
    ...
    result_lbl->setStyleSheet("background-color:white;color: green ;font: 10pt Gorgia");

    name_led->setStyleSheet("background-color: white;color: black ;font: 10pt Gorgia");
    author_led->setStyleSheet("background-color: white;color: black ;font: 10pt Gorgia");
    year_led->setStyleSheet("background-color: white;color: black ;font: 10pt Gorgia");
    price_led->setStyleSheet("background-color: white;color: black ;font: 10pt Gorgia");
    number_led->setStyleSheet("background-color: white;color: black ;font: 8pt Gorgia");

    back_btn->setStyleSheet("background-color: white");
    add_btn->setStyleSheet("background-color: rgb(102, 255, 232);color: black ;font: 10pt Gorgia");
    ...
    result_lbl->setText("<b>The Book Has Been Succesfully Added</b>");
    ...
    name_led->setGeometry(200,200,100,50);
    author_led->setGeometry(500,200,100,50);
    year_led->setGeometry(200,300,100,50);
    price_led->setGeometry(500,300,100,50);
    number_led->setGeometry(200,400,100,50);

    back_btn->setGeometry(0,0,75,50);
    add_btn->setGeometry(500,400,100,50);

    name_lbl->setGeometry(150,200,50,50);
    author_lbl->setGeometry(450,200,50,50);
    year_lbl->setGeometry(150,300,50,50);
    price_lbl->setGeometry(450,300,50,50);
    result_lbl->setGeometry(250,50,300,50);

    QPixmap pixmap(":/back/back1");
    QIcon ButtonIcon(pixmap);
    back_btn->setIcon(ButtonIcon);
    back_btn->setIconSize(QSize(60,38));
    back_btn->setFixedSize(QSize(75,50));
